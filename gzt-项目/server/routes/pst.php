...
//支付路由
Route::get('payment/alipay', 'PaymentController@payByAlipay')->name('payment.alipay');
...
Route::get('pay','Server\PayController@show');
Route::post('/pay/getMemberPayUrl','Server\PayController@getMemberPayUrl');//支付订单
Route::post('/getWxOpenIdAuthUrl','Server\SocialiteController@getWxOpenIdAuthUrl');//支付订单
//订单数据相关路由
Route::get('/order/show','Server\PayController@show')->name('order.show');

//测试用二维码路由
Route::get('qrcode','PayQrcodeController@index');

Route::get('/wechat_login', 'HomeController@wechat_login');
Route::get('/wechat_access', 'Server\SocialiteController@getWeChatAccessToken');
