 ...
 */
class PstExportTemplateListEnResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'name'=>$this->name,
            'count'=>$this->exportTems->where('is_show',1)->count(),
            'data'=>PstExportTemplateResource::collection($this->exportTems->where('is_show',1)),
